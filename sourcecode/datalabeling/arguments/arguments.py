...
# LABELSTUDIOCONFIG = os.path.join(
#     CUR_DIR, "../../../exported_annotations/label_studio_config.xml"
# )
...
class Arguments:
    ...
    data_config_yaml: str = (
        None  # os.path.join(CUR_DIR,'../../../data/data_config.yaml')
    )

    # labels to discard
    discard_labels: Sequence[str] = (
        None  # ('other','rocks','vegetation','detection','termite mound','label')
    )
