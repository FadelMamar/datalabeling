...
@REM call python tools\cli.py --start-training --batchsize 64  --epochs 50 --lr0 0.0001 --lrf 0.01 --patience 10 --is-detector^
@REM     --scale 0.0 --weight-decay 0.0005 --freeze 22^
@REM     --mlflow-model-alias "last"^
@REM     --data-config-yaml "C:\Users\Machine Learning\Desktop\workspace-wildAI\datalabeling\data\data_config.yaml" ^
@REM     --run-name "detector" --project-name "wildAI-detection"^
@REM     --tag "dataset-v3" "transferlearning"^ 

:: Transfer learning from a pth file
call python tools\cli.py --start-training --batchsize 64  --epochs 25 --lr0 0.0001 --lrf 0.01 --patience 10 --is-detector^
    --scale 0.0 --weight-decay 0.0005 --freeze 24^
    ...
    --tag "dataset-v4" "transferlearning"^
