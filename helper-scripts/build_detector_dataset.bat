...
@REM call uv run  build_dataset.py --build-yolo-dataset --clear-yolo-dir --empty-ratio 0.1 --parse-ls-config --is-detector^
...
@REM call uv run build_dataset.py --build-yolo-dataset  --is-detector --clear-yolo-dir --parse-ls-config --empty-ratio 0.1^
...
@REM :: Rep 1 dry data
@REM call uv run  build_dataset.py --build-yolo-dataset --clear-yolo-dir --empty-ratio 10. --parse-ls-config --is-detector --min-visibility 0.8 ^
...
@REM call uv run  build_dataset.py --build-yolo-dataset --clear-yolo-dir --empty-ratio 20. --parse-ls-config --is-detector --min-visibility 0.8 ^
...
@REM call uv run  build_dataset.py --build-yolo-dataset --clear-yolo-dir --empty-ratio 0. --save-all --parse-ls-config --is-detector --min-visibility 0.8 ^
