...
@REM call python  build_dataset.py --build-yolo-dataset --clear-yolo-dir --empty-ratio 0.1 --parse-ls-config --is-detector^
...
@REM call python build_dataset.py --build-yolo-dataset  --is-detector --clear-yolo-dir --parse-ls-config --empty-ratio 0.1^
