...
@REM      --coco-output-dir "D:\PhD\Data per camp\DetectionDataset\Identification-split\coco-dataset" --skip --clear-coco_dir

@REM call python  tools\build_dataset.py --obb-to-yolo --yolo-to-coco --data-config-yaml "data\dataset_identification.yaml" ^
@REM     --coco-output-dir "D:\PhD\Data per camp\IdentificationDataset\coco-dataset" --skip --clear-coco_dir
